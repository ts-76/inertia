...
- `@inertiajs/hono-jsx/server`, which re-exports the Inertia SSR server helper
...
```tsx
import { Form, Head, Link, usePage } from '@inertiajs/hono-jsx'
...
- `@inertiajs/hono-jsx`: client boot, component resolution, Hono JSX rendering, links,
...
This adapter exposes `@inertiajs/hono-jsx/server`, which re-exports the Inertia SSR server helper.
